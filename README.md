Title: Zombie Invasion 2nite
Author: Tyler Meyers
Video Demo:  <'https://youtu.be/HfMk_WfMGR4'>
...
Fun to get stuck on something and then either find a creative solution or a work around. I wasn't too hard on myself as this was my first game, so if I couldn't figure something out or do it the right way, I'd find a trick to still implement the feature or simply skip it for timesake.
